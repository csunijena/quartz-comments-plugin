...
var comments_inline_default = 'var u=s=>{let e=s.detail.theme,a=document.querySelector("iframe.giscus-frame");a&&a.contentWindow&&a.contentWindow.postMessage({giscus:{setConfig:{theme:d(c(e))}}},"https://giscus.app")},m=s=>{let e=s.detail.theme,a=document.querySelector(".beblob");if(!a)return;let t=e==="dark"?"dark":"light";a.setAttribute("data-theme",t);let i=document.getElementById("beblob-script");i&&i.setAttribute("data-theme",t)},c=s=>{if(s!=="dark"&&s!=="light")return s;let e=document.querySelector(".giscus");if(!e)return s;let a=e.dataset.darkTheme??"dark",t=e.dataset.lightTheme??"light";return s==="dark"?a:t},d=s=>{let e=document.querySelector(".giscus");return e?`${e.dataset.themeUrl??"https://giscus.app/themes"}/${s}.css`:`https://giscus.app/themes/${s}.css`},r=[],o=s=>{r.push(s)};if(typeof document<"u"){let s=()=>{r.forEach(t=>t()),r.length=0;let e=document.querySelector(".giscus"),a=document.querySelector(".beblob");if(e){let t=document.createElement("script");t.src="https://giscus.app/client.js",t.async=!0,t.crossOrigin="anonymous",t.setAttribute("data-loading","lazy"),t.setAttribute("data-emit-metadata","0"),t.setAttribute("data-repo",e.dataset.repo),t.setAttribute("data-repo-id",e.dataset.repoId),t.setAttribute("data-category",e.dataset.category),t.setAttribute("data-category-id",e.dataset.categoryId),t.setAttribute("data-mapping",e.dataset.mapping),t.setAttribute("data-strict",e.dataset.strict),t.setAttribute("data-reactions-enabled",e.dataset.reactionsEnabled),t.setAttribute("data-input-position",e.dataset.inputPosition),t.setAttribute("data-lang",e.dataset.lang);let i=document.documentElement.getAttribute("saved-theme");i&&t.setAttribute("data-theme",d(c(i))),e.appendChild(t);let n=u;document.addEventListener("themechange",n),o(()=>document.removeEventListener("themechange",n))}else if(a){if(!a.querySelector("#beblob-script")){let n=document.createElement("script");n.id="beblob-script",n.src="https://unpkg.com/beblob@2.1.0/dist/beblob.js",n.setAttribute("data-client-id",a.dataset.clientId),n.setAttribute("data-redirect-uri",a.dataset.redirectUri),n.setAttribute("data-project-name",a.dataset.projectName),n.setAttribute("data-issue-mapping-strategy",a.dataset.issueMappingStrategy),n.setAttribute("data-theme",a.dataset.theme),n.setAttribute("data-lang",a.dataset.lang),n.setAttribute("data-gitlab-url",a.dataset.gitlabUrl),n.setAttribute("data-beblob-version","2.1.0"),a.appendChild(n)}let i=m;document.addEventListener("themechange",i),o(()=>document.removeEventListener("themechange",i))}};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",s):s(),document.addEventListener("nav",s),document.addEventListener("render",s)}\n';
var l;
function S(n2) {
  return n2.children;
}
